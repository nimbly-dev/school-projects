    ...
    for (var i in cartArray) {
        output =
            ...
            <div class="col mt-1 mb-2 d-inline-flex d-flex align-self-end">
                ...
                <input type="hidden" value="${cartArray[i].productImgPath}" name="productName">
                ...
                <h6 class="d-flex align-self-end " style="margin-left: 4rem;">P ${cartArray[i].productPrice}</h6>
