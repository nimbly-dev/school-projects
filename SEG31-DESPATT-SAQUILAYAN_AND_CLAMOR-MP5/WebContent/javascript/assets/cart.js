...
function displayCart() {
    ...
    document.getElementById('totalItemCount').value = shoppingCart.totalCount();//Total Count
}
displayCart();
...
function assortedCupcakeMenuOrder() {
    var displayCartArray = [];

    var avocadoCupcakes = new cartItem("Avocado Cupcake", 15, "images/products/avocado-biscuit-cupcake.PNG", 3);//Avocado Cupcake
    var valentineCupcakes = new cartItem("Valentine Cupcake", 30, "images/products/valentine-cupcake.jpg", 3);//Valentine Cupcake
    var strawberryCupcakes = new cartItem("Strawberry Cupcake", 25, "images/products/valentine-cupcake.jpg", 3);//Strawberry Cupcake

    displayCartArray.push(avocadoCupcakes);
    displayCartArray.push(valentineCupcakes);
    displayCartArray.push(strawberryCupcakes);
}

function candyManiaMenuOrder() {
    var displayCartArray = [];

    var candyCane = new cartItem("Candy Cane", 10, "images/products/candy-cane.jpg", 10);
    var jellyBeans = new cartItem("Jelly Beans", 10, "images/products/jelly-beans.jpg", 5);

    displayCartArray.push(candyCane);
    displayCartArray.push(jellyBeans);
}
